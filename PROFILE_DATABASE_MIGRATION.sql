-- Profile Management Database Migration
...
WHERE table_name = 'user_profiles' 
    ...
    AND column_name IN ('name', 'phone_verified', 'upi_id', 'referral_earnings', 'total_referrals')
...
WHERE table_schema = 'public' 
    AND table_name IN ('phone_verifications', 'daily_visits', 'referral_transactions')
ORDER BY table_name;
