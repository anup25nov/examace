-- Final fix for activate_or_upgrade_membership function
-- Run this script in your Supabase SQL Editor

-- 1. Drop and recreate the function with guaranteed plan_id handling
DROP FUNCTION IF EXISTS activate_or_upgrade_membership(UUID, VARCHAR, TIMESTAMP WITH TIME ZONE);

-- 2. Create the final fixed function
...
BEGIN
  ...
  -- Insert or update membership with guaranteed plan_id
