-- Fix the commission record with NULL referrer_id
-- Update it with the correct referrer_id

-- Step 1: Check the commission record with NULL referrer_id
...
-- Step 2: Update the commission record with correct referrer_id
