-- Create validate_and_apply_referral_code function (Fixed Version)
-- Run this script in your Supabase SQL Editor

-- 1. Drop existing function first to avoid conflicts
...
-- 2. Create the validate_and_apply_referral_code function
