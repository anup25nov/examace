-- Complete End-to-End Test for Referral Commission System
...
-- Step 4: Check U1's earnings after commission
SELECT '=== U1 EARNINGS AFTER COMMISSION ===' as step;
SELECT 
    user_id,
    code,
    total_referrals,
...
-- Step 5: Check commissions created
SELECT '=== COMMISSIONS CREATED ===' as step;
SELECT 
    referrer_id,
    referred_id,
    membership_plan,
...
-- Step 6: Check referral transactions
