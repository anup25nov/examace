-- Fix referral network data display (corrected column names)
...
-- Step 4: Check memberships table (corrected columns)
...
-- Step 8: Check if there's a data mismatch
SELECT '=== DATA MISMATCH CHECK ===' as step;

SELECT 
  'Data mismatch analysis:' as info,
  'Referral transaction amount:' as field1,
  rt.amount as value1,
  'Commission amount:' as field2,
  rc.commission_amount as value2,
  'Membership amount in commission:' as field3,
  rc.membership_amount as value3
FROM referral_transactions rt
LEFT JOIN referral_commissions rc ON rt.referred_id = rc.referred_id
WHERE rt.referrer_id = 'ad1cff7d-11e8-4a99-8a4e-1f44fb6db0fb'
  AND rt.referred_id = 'b2975c5b-c04b-4929-b8ac-9f3da1b155b8';
