-- Find the mismatch between payments and referral transactions
-- This will help us understand why commissions aren't being processed
...
-- Step 3: Find users who have payments but no referral transactions
...
-- Step 4: Find users who have referral transactions but no payments
...
-- Step 5: Check if there are any users who have both payments and referral transactions
...
-- Step 6: Check the most recent referral transaction
...
-- Step 7: Check if the most recent referral user has any payments
