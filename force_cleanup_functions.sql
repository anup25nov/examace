-- Force cleanup of all process_referral_commission functions
-- Run this in your Supabase SQL Editor

-- 1. Drop ALL functions by specific name
SELECT '=== DROPPING FUNCTIONS BY SPECIFIC NAME ===' as step;
...
-- 2. Also try to drop by function name (in case there are more)
SELECT '=== DROPPING BY FUNCTION NAME ===' as step;
...
BEGIN
    ...
    LOOP
        -- Drop each function by its specific name
