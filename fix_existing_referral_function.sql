-- Fix the existing create_user_referral_code function to work without unique constraint
-- This updates the existing function that takes (user_uuid, custom_code) parameters
