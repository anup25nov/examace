-- Sync Membership Plans with Centralized Configuration (Direct)
-- Run this script directly to sync the database with appConfig.ts

-- Upsert plans from centralized configuration (Free plan removed - default for all users)
