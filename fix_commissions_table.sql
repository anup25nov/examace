-- Fix the referral_commissions table structure
...
ADD COLUMN IF NOT EXISTS membership_plan VARCHAR(50),
ADD COLUMN IF NOT EXISTS membership_amount NUMERIC(10,2),
ADD COLUMN IF NOT EXISTS commission_rate NUMERIC(5,4),
ADD COLUMN IF NOT EXISTS payment_id UUID;

-- 3. Update the function to use the correct column names
...
-- 5. Check commissions with correct columns
