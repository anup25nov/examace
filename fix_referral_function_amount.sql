...
-- 1. Drop and recreate the function with proper amount handling
...
BEGIN
  ...
  -- Create referral transaction with proper amount values
...
-- 4. Test the function
SELECT 'validate_and_apply_referral_code function fixed successfully!' as status;
