-- Fix type mismatches in referral functions

-- 1. Fix get_referral_network_detailed function
...
BEGIN
  ...
  SELECT 
    ...
    CASE 
      ...
      ELSE up.phone
    END::TEXT as referred_phone_masked,
    up.created_at,
...
-- 2. Fix get_comprehensive_referral_stats function
