-- Fix question reports RLS issue by creating RPC function
-- This allows phone-based auth users to submit question reports
...
-- Also create a function to check existing reports (used in the component)
