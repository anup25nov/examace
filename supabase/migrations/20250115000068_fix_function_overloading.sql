-- Fix function overloading conflict for upsert_test_completion_simple
...
DROP FUNCTION IF EXISTS upsert_test_completion_simple(UUID, VARCHAR(50), VARCHAR(20), VARCHAR(100), INTEGER, INTEGER, INTEGER, INTEGER, JSONB, VARCHAR(100));

-- Create single, consistent upsert_test_completion_simple function
