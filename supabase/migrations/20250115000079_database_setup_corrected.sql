...
BEGIN
    ...
    VALUES 
    (user1_id, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'testuser1@example.com', '$2a$10$dummy.hash.for.testing.purposes.only', NOW(), NULL, '', NOW(), '', NOW(), '', '', NOW(), NOW(), '{"provider": "email", "providers": ["email"]}', '{}', false, NOW(), NOW(), '+919876543210', NOW(), '', '', NOW(), '', 0, NULL, '', NOW()),
    (user2_id, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'testuser2@example.com', '$2a$10$dummy.hash.for.testing.purposes.only', NOW(), NULL, '', NOW(), '', NOW(), '', '', NOW(), NOW(), '{"provider": "email", "providers": ["email"]}', '{}', false, NOW(), NOW(), '+919876543211', NOW(), '', '', NOW(), '', 0, NULL, '', NOW());
