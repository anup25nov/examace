...
-- 5. Insert membership plans with proper UUIDs
...
-- 6. Create a function to generate test data
...
-- 7. Execute the function to create test data
SELECT create_test_users();

-- 8. Drop the function after use
