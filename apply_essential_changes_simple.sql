-- Simple Essential Changes for Step2Sarkari
-- This script applies only the essential changes without function conflicts
...
-- 5. Grant permissions
GRANT EXECUTE ON FUNCTION process_referral_commission(UUID, VARCHAR, DECIMAL, UUID) TO authenticated;
GRANT EXECUTE ON FUNCTION get_user_referral_earnings(UUID) TO authenticated;
GRANT EXECUTE ON FUNCTION request_withdrawal(UUID, DECIMAL, VARCHAR, TEXT) TO authenticated;
