-- Fix get_referral_network_detailed function - remove non-existent column
...
BEGIN
  ...
  SELECT 
    ...
    -- Use rt.first_membership_only instead of rc.is_first_membership
  ...
  LEFT JOIN user_memberships m ON m.user_id = rt.referred_id
