...
export const ReferralSystem: React.FC<ReferralSystemProps> = ({ onClose }) => {
  ...
  return (
    ...
    >
      <div className={`bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[calc(100vh-env(safe-area-inset-top)-env(safe-area-inset-bottom)-2rem)] overflow-y-auto ${isMobile ? 'mx-2' : ''}`}>
        {/* Header */}
